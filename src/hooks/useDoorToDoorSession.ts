  ...
  const startSession = async (): Promise<FieldSession | null> => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.error('Error', { description: 'Failed to start session' });
        return null;
      }
      ...
      toast.success('🚪 Session Started!', { description: 'Start knocking doors to earn points!' });
  ...
  const endSession = async (): Promise<void> => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.error('Error', { description: 'Failed to end session' });
        return;
      }
  ...
  const recordDoorKnock = async (
    ...
    try {
      ...
      if (error) {
        ...
        toast.error('Error', { description: 'Failed to record door knock' });
        return null;
      }
