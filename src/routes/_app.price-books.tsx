...
function PricingPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Insurance pricing from Xactimate exports and retail pricing built from master macros.
          </p>
        </div>
      </div>
      ...
      {tab === "insurance" ? (
        <InsuranceTab books={insuranceBooks} loading={isLoading} />
      ) : (
...
function InsuranceTab({ books, loading }: { books: PriceBook[]; loading: boolean }) {
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <p className="text-xs text-muted-foreground">
          Insurance books use Xactimate line items and pricing for carrier-aligned estimates.
        </p>
        <Link
          to="/price-books/new"
      ...
      <div className="rounded-xl border" style={{ borderColor: "var(--border)", backgroundColor: "var(--surface)" }}>
        {loading ? (
          ...
          <div className="p-12 text-center">
            <p className="text-sm text-muted-foreground">No insurance books yet.</p>
