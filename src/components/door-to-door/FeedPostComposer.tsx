...
export function FeedPostComposer({ 
  ...
  const startRecording = async () => {
    try {
      ...
      toast.error("Camera Error", { description: "Unable to access camera. Please check permissions." });
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Posted!", { description: "Your update is now live" });
      ...
      toast.error("Error", { description: "Failed to create post. Please try again." });
    } finally {
